...
<h3 align="left">Featured projects: </h3>
 ...
 - [vFit](https://github.com/guilefoylegaurav/vFit)
	 - A web-app where users can exercise with partners virtually over video under the discretion of an AI.
	- Won **First Place** in **HackOn with Amazon 2021** among **140+ ideas from all over India**.
- [Flush](https://github.com/guilefoylegaurav/flush)
	- Discover restrooms in new places using restroom map, or lease out your own. 
...
<strong>Working with Data</strong>
 - **automation** using selenium-python, scrapy
 - **sklearn, pandas, tensorflow**
 - Experience embedding **computer vision** into apps
 
<strong>Languages I know</strong>
- **Fluent**: C++, Java, Python
- **Intermediate**: SQL, C
...
<a href="https://linkedin.com/in/gaurav-bhattacharjee-19a387a8" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="gaurav-bhattacharjee-19a387a8" height="30" width="40" /></a>
